                ...
                <form class="form-inline" role="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"
                               id="qname" placeholder="供应商名字">
                    </div>
                    <div class="form-group">
                        <label for="loc">名字:</label>
                        <input type="text" class="form-control"
                               id="loc" placeholder="供应商地址">
                    </div>
...
<script>
    ...
    function queryData(pageNumber,pageSize,tj){
        $.ajax({
            type:"POST",
            url:"gys",                                                             // &name=xx&address=xxx
            data:"method=querySome&pageNumber="+pageNumber+"&pageSize="+pageSize+tj,
            dataType:"json",
            success:msg=>{//msg==>{} {pageNumber:xx,pageSize:xx,pre:xx,next:xxx,rows:[{id:xx,name:xx,address:xx},{}]}   [{key:value,}]
                ...
                $.each(msg.rows,function(i,yz){
                    ...
                    <td>${msg.start+i+1}</td><td>${yz.name}</td><td><button onclick="queryById('${yz.loc}')" type='button' class='btn btn-danger'>
                    详情</button></td></tr>`;
